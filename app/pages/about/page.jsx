                    ...
                    <div className="min-h-[70vh] w-full">
                        ...
                        <TabsContent value="about" className="w-full text-center lg:text-left">
                            <div className="flex flex-col gap-[30px]">
                                ...
                                <p>Hello, I’m <strong className="text-white">Sakhawat Hossen</strong>, an enthusiastic and self-driven <strong className="text-white">Frontend web Developer</strong> with a strong foundation in <strong className="text-white">HTML, CSS, JavaScript, and React.</strong> Looking for an opportunity to apply my skills, gain hands-on experience, and develop scalable, visually appealing user interfaces in a dynamic organization.</p>
