                    ...
                    <div className="min-h-[70vh] w-full">
                                            ...
                                            return <li key={i}>
                                                <TooltipProvider delayDuration={100}>
                                                    <Tooltip>
                                                        ...
                                                        <TooltipContent className="bg-accent border-accent">
                        ...
                        <TabsContent value="about" className="w-full text-center lg:text-left">
                            <div className="flex flex-col gap-[30px]">
                                ...
                                <p>Hello, I’m <strong className="text-white">Sakhawat Hossen Fahad</strong>, a passionate <strong className="text-white">Frontend Web Developer</strong> with a keen eye for creating intuitive, user-friendly, and responsive web experiences. With a strong foundation in modern web technologies like React and expertise in building seamless interfaces, I’m dedicated to turning creative ideas into functional digital solutions.</p>
